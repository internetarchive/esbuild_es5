...
Options:
  ...
  -t, --target                     output target format. defaults to es6 (AKA es
                                   2015), the oldest option     [default: "es6"]
  -p, --platform                   platform target, browser or node
                                                            [default: "browser"]
      --import_map                 import map file to use [string] [default: ""]
